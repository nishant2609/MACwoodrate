...
class _MenuScreenState extends State<MenuScreen> {
                  ...
                  children: [
                    ...
                    Expanded(
                      child: _buildStatCard(
                        ...
                        value:
                        '₹${_formatNumber(_stats['totalRevenue'] as double)}',
        ...
        child: Column(
          ...
          children: [
            ...
            if (_recentOrders.isEmpty) ...[
              ...
              ..._recentOrders
                  .map((order) => _buildOrderTile(order, isSmallScreen))
                  .toList(),
            ],
          ],
        ),
  ...
  Widget _buildOrderTile(app_models.Order order, bool isSmallScreen) {
    return Container(
